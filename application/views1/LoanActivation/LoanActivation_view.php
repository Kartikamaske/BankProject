  ...
  <div class=" mb-3 d-flex justify-content-start align-items-center" style="gap:10px">
    ...
    border-radius: 6px!important;color: green;" name="totalInstallmentAmt"    value="<?php if(!empty($data)){echo $data[0]->totalInstallmentAmt;}else{ echo '0';} ?>" readonly>
                  ...
                  <!-- <div class="col-md-2 divv divvv dd">
                    ...
                    <label >एकूण व्याज र.  <span>( वार्षिक ) </span></label>
                      <div class="input-group">
                        <input type="number" class="form-control form-control-sm bg-white" id="interestamt" name="interestamt" placeholder="व्याज र." readonly   value="<?php if(!empty($data)){echo $data[0]->interestamt;}else{ echo '0';} ?>" required>
                     
                      </div>
                  </div>
                  <div class="col-md-2 divv divvv dd">
                    <label> व्याज र.  <span> ( Per Day ) </span></label>
                      <div class="input-group">
                        <input type="number" class="form-control form-control-sm bg-white" id="interetotalstamt" name="interetotalstamt" placeholder="व्याज र." readonly   value="<?php if(!empty($data)){echo $data[0]->interetotalstamt;}else{ echo '0';} ?>" >
                     
                      </div>
                  </div>
                   <div class="col-md-4 col-lg-3 divv divvv dd">
                    <label>एकूण मुद्दल र.</label>
                      <div class="input-group">
                        <input type="number" class="form-control form-control-sm bg-white" id="totalInstallmentAmt" name="totalInstallmentAmt" placeholder="Total Amount"   value="<?php if(!empty($data)){echo $data[0]->totalInstallmentAmt;}else{ echo '0';} ?>" readonly>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <label class="control-label">Document</label> <label for="" id="alertMsgDuplicateItem" class="validation-msg">&nbsp; </label>
                                             ...
                                             <select class="select2 form-control select2-hidden-accessible" id="licencetypeId" name="licencetypeId" style="width: 100%; height:36px;">
                                                ...
                                                <option value="2">PAN</option><option value="3">Voter Id</option>                               
                            </select>           
                                          </div> 
