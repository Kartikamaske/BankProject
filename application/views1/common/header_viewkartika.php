    ...
    <div class="app-admin-wrap layout-sidebar-large" >
        <div class="main-header">
            <div class="logo" style="margin: 0 -17px;">
                <img src="<?=base_url();?>Assets/images/comlogo.png" alt="" class="mx-auto">
            </div>
            ...
            <div class="header-part-right">
                ...
                <div class="dropdown " >
                    <div class="user col align-self-end">
                        ...
                        <a class="dropdown-item text-primary" href="#">Log out</a>
        ...
        <div class="side-content-wrap">
            <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                <ul class="navigation-left">
                    ...
                    <li class="nav-item" data-item="extrakits" data-bs-toggle="tooltip" data-bs-placement="top" title="Loan Activation">
                        <a class="nav-item-hold text-decoration-none"  href="<?=base_url()?>LoanActivation">
            ...
            <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                ...
                <li class="nav-item"><a class="text-decoration-none" href="<?=base_url();?>Attendance/create">
                    <span class="item-name ms-5" style="color:var(--themecolor);font-size: 18px;margin-left:30px;">Member Data</span></a>
                </li>


                    <li class="nav-item"><a class="text-decoration-none" href="<?=base_url();?>MemberRegistration/create"> 
                    <i class="fa-solid fa-user-plus fa-xl"></i>
                    &emsp;<span class="item-name">Add Member</span></a></li>

                    <li class="nav-item"><a class="text-decoration-none" href="<?=base_url();?>MemberRegistration">
                    <i class="fa-solid fa-user-check fa-xl"></i>
                   &emsp;<span class="item-name">Member Detail</span></a></li>
                ...
                <ul class="childNav" data-parent="extrakits">
                   ...
                   <li class="nav-item"><a class="text-decoration-none" href="<?=base_url();?>LoanActivation">
                    <span class="item-name" style="color:#2f67cd;font-size: 18px;margin-left: 5px;">Loan Activation</span></a>
                   </li>
                    ...
                    <li class="nav-item"><a class="text-decoration-none" href="<?=base_url();?>LoanActivation">
                    <i class="fa-regular fa-square-caret-down fa-xl"></i>
                    &emsp;<span class="item-name">Edit Loan Activation</span></a></li>
                ...
                <ul class="childNav" data-parent="depositedetails">
                   ...
                   <li class="nav-item"><a class="text-decoration-none" href="<?=base_url();?>LoanActivation">
                    <span class="item-name" style="color:#2f67cd;font-size: 18px;margin-left: 5px;">Deposite</span></a>
                   </li>


                    <li class="nav-item"><a class="text-decoration-none" href="<?=base_url();?>Deposite/create">
                    <i class="fa-regular fa-square-caret-down fa-xl"></i>
                    &emsp;<span class="item-name">Deposite Create</span></a></li>

                    <li class="nav-item"><a class="text-decoration-none" href="<?=base_url();?>Deposite">
                    <i class="fa-regular fa-square-caret-down fa-xl"></i>
                ...
                <!-- <ul class="childNav" data-parent="taskrequirementlinks">
                    ...
                    <img width="38" height="38" src="https://img.icons8.com/stickers/100/add-property.png" alt="add-property"/>&emsp;<span class="item-name">Taskdetails</span></a></li>
