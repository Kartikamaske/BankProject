...
">&ensp;Member Registration</h3>
                       <hr class="my-2">
                            <form role="form" id="Form" enctype="multipart/form-data" action="" method="post">

                            <input type="hidden" class="form-control" id="memberid"  name="memberid" value="<?php if(!empty($dataa[0]->memberid)){echo $dataa[0]->memberid;}?>"></br>


                            <div class="form-row"> 
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3" hidden>
                                    <label for="">Member Code <span class="text-danger">*</span></label>
                                    <!-- We check if $dataa[0]->membercode is not empty. If it's not empty, it means that id > 0 -->
                                    <?php
                                        $readonly = '';
                                        if (!empty($dataa[0]->membercode)) {
                                            $readonly = 'readonly';
                                        }
                                    ?>

                                    <input type="number" name="membercode" id="membercode" class="form-control" value="<?php if (!empty($dataa[0]->membercode)) { echo $dataa[0]->membercode; } ?>" min="1" onchange="checkMobileNumber()" <?php echo $readonly; ?>>
                            ...
                            <!-- <div class="form-row">  -->
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 mt-3">
                                    ...
                                    <input type="text" style="    background: #cfdde6;
" name="fullname" id="fullname"  class="form-control border-0" value="<?php if(!empty($dataa[0]->fullname)){echo $dataa[0]->fullname;}?>" readonly>
                                </div>   


                                <div class="col-12 col-sm-12 col-md-4 col-lg-2 md-5 mt-3">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-2 mt-3">
                           ...
                           <div id="Details" class="collapse mt-5 show" style="">
                             <div class="form-row"> 
                                ...
                                <!-- <div class="form-row">  -->
                                    ...
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-3 md-5 text-center" style="position:relative;">
                                           ...
                                           <input type="file" class="form-control form-control-sm" id="photo1" name="photo1"  onchange="readimage1(this,'profile-img-tag1');" value="<?php if(!empty($dataa))echo $dataa[0]->photo1; ?>"  >
                                                                
                                            <?php if(!empty($dataa[0]->photo1)){
                                            ?>
                                                <img src="<?php echo base_url();?>upload/<?php echo $dataa[0]->photo1 ?>" id="profile-img-tag1" calss="img-thumbnail" style="margin: 10px 32px;height:100px;width:40%;border-radius: 10px; margin-top: 20px;position:absolute;bottom:-193%;left:17%;"> 
                                            <?php } else
                                            // these is for at the time of update bydefault image not show
                                                 echo '<img src="'.base_url().'Assets/images/user.png" id="profile-img-tag1" calss="img-thumbnail" style="margin: 10px 32px;height:100px;width:40%;border-radius: 10px; margin-top: 20px;position:absolute;bottom:-193%;left:17%;" />';
                             ...
                             <br>
                                    <div class="col-12 col-sm-12 col-md-4 col-lg-5 mt-3">
                                        ...
                                        <textarea class="form-control custom-control" rows="3" id="address" name="address"  onkeypress="return onlyAlphabets(event,this)" required="" data-parsley-id="3139"><?php if(!empty($dataa[0]->address)){echo $dataa[0]->address;}?></textarea>
                                    </div>
                                </div>
                             ...
                             <div class="col-md-12 text-center p-5">
                                ...
                                <i class="fa-regular fa-circle-check"></i> Submit
                                 ...
                                 <a href="<?=base_url() ?>MemberRegistration" style="" class=" border-0 text-white btn btn-primary  text-white btncancel" type="button" name="cancle" id="cancle">
...
<script>
    ...
    // var id = document.getElementById('membercode').value;
    //  if (id > 0) {
    //     var Gender = "<?php if (!empty($data)) echo $data[0]->gender; ?>";
    //     // alert(gender);
