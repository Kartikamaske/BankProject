...
(function(h) {
	...
	n.defaults = {
		...
		oLanguage: {
			...
			sInfo: "Showing _START_ to _END_entries",
...
(function(b) {
	...
	b.extend(!0, f.defaults, {
		dom: "<'row'<'col-sm-6 col-xs-6 col-md-6'l><'col-sm-6 col-xs-6 col-md-6'f>><'row'<'col-sm-12'tr>><'row align_center'<'col-sm-6 col-xs-6 col-md-5'i><'col-sm-6 col-xs-6 col-md-7'p>>",
		renderer: "bootstrap"
	});
	...
	f.ext.renderer.pageButton.bootstrap = function(a, h, r, s, j, n) {
		...
		q(b(h).empty().html('<ul class="pagination has-gap"/>').children("ul"), s);
